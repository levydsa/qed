...
export function hash_hex(key, m) {
  var r = hash(key, m);
  return (
...
export function hash_uint(key, m) {
  var r = hash(key, m);
  return (r.h & 0x1fffff) * 0x100000000 + r.l;
}

export function string_to_u8(str) {
...
export function string16_to_key(str) {
